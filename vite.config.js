...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'Home Circuit — 7-Day Training Board',
        short_name: 'Home Circuit',
        description: 'A minimal-equipment, 7-day home training plan with form videos, filters, and exercise tracking.',
        theme_color: '#15171a',
